    ...
    <section className="w-full py-20 px-4 bg-white">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-5">
          ...
          <Button className="w-50 h-14 cursor-pointer rounded-full font-semibold text-primary bg-white border-2 border-primary hover:bg-primary-light">
            Browse Directory
            <ArrowRight size={16} />
          </Button>
        </div>
            ...
            >
              <CardContent className="p-2 flex items-start gap-4">
                <div
                  ...
                  style={{ backgroundColor: getAvatarColor(mentor.id) }}
                >
                  {mentor.initials}
                </div>

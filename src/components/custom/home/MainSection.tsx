...
export default function MainSection() {
  return (
    <section
      className="relative w-full min-h-screen py-25 overflow-hidden flex items-center"
    ...
    >
      ...
      <div
        className="absolute inset-0 h-full opacity-75"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="mb-20">
            ...
            <p className="text-lg mb-8 leading-relaxed text-white/80">
              Pathly gives fresh graduates a personalized roadmap, an ATS-ready
              CV, and direct matches to jobs, internships, and scholarships.
            </p>
          ...
          <div className="hidden lg:flex justify-end">
            <div
              className="w-full max-w-100 rounded-2xl backdrop-blur-xl border border-white/10 p-6"
              style={{
                backgroundColor:
                  "color-mix(in srgb, var(--primary-darker) 75%, transparent)",
            ...
            >
              ...
              <div className="mt-6 pt-6 border-t border-white/10 flex justify-between text-white/70 text-sm">
                <div className="flex items-center gap-2">
                  <Briefcase className="w-4 h-4" />3 job matches
                </div>
                <div className="flex items-center gap-2">

      ...
      <div className="bg-white rounded-xl border border-gray-200 p-4 sm:p-5">
        {education && education.length > 0 ? (
          <div className="space-y-6">
            {education.map((edu) => (
              <div key={edu.id} className="flex flex-col sm:flex-row items-start space-y-3 sm:space-y-0 sm:space-x-4">
                ...
                <div className="flex-1 w-full">
                  <div className="flex flex-col sm:flex-row items-start sm:items-start justify-between gap-2 sm:gap-0">
                    <div className="w-full sm:w-auto">
                      <h4 className="font-semibold text-foreground break-words">{edu.institution}</h4>
